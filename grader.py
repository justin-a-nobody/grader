...
with open('databaseconfig.json') as config_file:
...
def save_upload_details(filename, watermarked_image_path, uploader_ip, grade, card_number, card_maker, card_player, card_year, card_type, image_url, spec_info):
    ...
    cursor = conn.cursor()
    query = """
    INSERT INTO uploads (filename, watermarked_image_path, uploader_ip, grade, card_number, card_maker, card_player, card_year, card_type, image_url, spec_info)
    VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
    """
    cursor.execute(query, (filename, watermarked_image_path, uploader_ip, grade, card_number, card_maker, card_player, card_year, card_type, image_url, spec_info))
    conn.commit()
    cursor.close()
    conn.close()
...
def upload_file():
    if request.method == 'POST':
        ...
        save_upload_details(filename, watermarked_image_path, uploader_ip, grade, card_number, card_maker, card_player, card_year, card_type, image_url, spec_info)
...
if __name__ == '__main__':
    app.run(host='your.ip3', port=8080, debug=True)
